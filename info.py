...
# Bot information
SESSION = environ.get('SESSION', 'LazyBotv2')
...
PICS = (environ.get('PICS', ' https://repgyetdcodkynrbxocg.supabase.co/storage/v1/object/public/images/telegram-1774682557878-a4e3a695.jpg')).split()

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1957949115').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003688587446').split()]
